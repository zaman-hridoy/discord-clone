        ...
        <div className="flex flex-col w-full">
          ...
          {isImage && (
            <a
              ...
              className="relative w-48 h-48 border rounded-md overflow-hidden bg-secondary flex items-center mt-2 aspect-square"
            >
              <Image
                src={fileUrl}
                alt={content}
          ...
          {!fileUrl && !isEditing && (
            <p
              className={cn(
                ...
                deleted &&
                  "italic text-zinc-500 text-xs mt-1 bg-zinc-100 px-2 py-1 inline-block w-max rounded-full"
              )}
            >
              {content}
              {isUpdated && !deleted && (
